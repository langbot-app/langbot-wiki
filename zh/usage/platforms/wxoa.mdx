---
title: "微信公众号"
description: "用 LangBot 搭建微信公众号 AI 机器人，将大模型接入你的微信公众号。"
icon: "/images/platforms/wechat.svg"
---
...
![控制台页面](/images/zh/deploy/bots/wxoa/wxoa1.png)


## 设置回调地址

<Tip>
**微信公众号需要公网域名和 HTTPS。** 如果你没有服务器，[LangBot Cloud](https://space.langbot.app/cloud) 自带域名解析，注册即可直接使用。
</Tip>

### 获取配置项 

点击`设置与开发`，`开发接口管理`，出现这样的页面：
![设置开发项](/images/zh/deploy/bots/wxoa/wxoa2.png)
...
![设置开发项](/images/zh/deploy/bots/wxoa/connect_to_langbot.png)
