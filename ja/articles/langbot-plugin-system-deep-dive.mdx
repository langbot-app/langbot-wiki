---
title: "LangBot プラグインシステム詳解：プロセス分離・イベント駆動・コンポーネント設計"
...
この記事は LangBot Blog から同期されています。 [Blog の原文を読む](https://langbot.app/en/blog/langbot-plugin-system-deep-dive).

公開日：2026-02-23 · 著者：LangBot Team
...
If you're interested in developing LangBot plugins, start with the [plugin development docs](https://langbot.app/docs/en/plugin/dev/tutor), or browse existing plugins on the [marketplace](https://space.langbot.app/market) for inspiration.
