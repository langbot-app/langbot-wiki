---
title: "機能"
description: "LangBot の機能を紹介：マルチプラットフォーム対応、複数 LLM、内蔵 Agent、RAG ナレッジベース、プラグイン、MCP。"
---
...
| [TBox (Ant TreasureBox)](https://tbox.cn/) | ✅ | LLMOpsプラットフォーム |
...
| --- | --- | --- |
| Agent | ✅ |  |
| RAG | ✅ | ベクトルデータベースとしてChromaを使用、再順位付けをサポート |
