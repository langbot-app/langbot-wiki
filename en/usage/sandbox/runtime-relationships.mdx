...
| Need | Use this |
|------|----------|
| Let the Agent run code, install dependencies, or read/write temporary files | Sandbox |
| Add a specialized workflow or template for the Agent | Skill |
| Connect an existing MCP tool service | MCP Server |
| Long-lived capability + background config + events | Plugin |
