...
description: "Build a WeCom (Enterprise WeChat) AI bot with LangBot to bring LLM chat into your organization."
---
...
![One-Click Create Bot](/images/zh/deploy/bots/wecom/wecombot/wecombot_oneclick.png)

4. Scan the QR code with WeCom. On your phone, tap **One-Click Create Intelligent Bot**

![Phone One-Click Create](/images/zh/deploy/bots/wecom/wecombot/wecombot_scan_create.png)
...
![Fill Bot Name](/images/zh/deploy/bots/wecom/wecombot/wecombot_fill_name.png)
...
![Streaming Toggle](/images/zh/deploy/bots/wecom/wecombot/wecombot_12.png)
