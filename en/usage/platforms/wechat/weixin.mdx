---
title: "Personal WeChat (OpenClaw)"
description: "Build a personal WeChat AI bot with LangBot. Connect large language models to your WeChat account."
---

## Introduction

[OpenClaw](https://github.com/dingxiang-me/OpenClaw-Wechat) is an open-source AI Agent framework. Through the OpenClaw WeChat adapter, you can connect LangBot to your personal WeChat account, supporting single chat, streaming output, whitelist control, and more.
