---
title: "Models"
description: "Configure LLM providers in LangBot: OpenAI GPT, Anthropic Claude, Google Gemini, DeepSeek, Qwen, Ollama and OpenAI-compatible models."
---
...
### Using the seekdb Built-in Embedding Model (Optional Dependency Required)
