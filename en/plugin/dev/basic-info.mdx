...
> **Note:** Cross-form cascading relationships (e.g. `creation_schema` values reading from `retrieval_schema` values and vice versa in a RAG Engine) are supported in the latest LangBot frontend.
