...
By default, this starts `langbot` and `langbot_plugin_runtime`. To enable Box-dependent features such as the sandbox, stdio MCP hosting, and Skill add/edit, run:
