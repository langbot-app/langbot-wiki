...
description: "Compare LangBot feature support across messaging platforms: Discord, Telegram, WeChat, Slack, QQ, Lark, DingTalk and more."
---
...
| Receive private messages | ✅ |  |
| Receive group mention messages | ✅ |  |
| Receive group regular messages | ❌ | QQ Official Bot only supports receiving mention messages |
| Receive image messages | ✅ |  |
| Receive voice messages | ❌ |  |
| Receive file messages | ❌ |  |
| Receive rich text messages | ❌ |  |
| Get private message event user name | ❌ | QQ Official Bot does not support getting user name |
| Get group message event group name | ❌ | QQ Official Bot does not support getting group name |
| Get group message event sender name | ❌ | QQ Official Bot does not support getting sender name |
...
| --- | --- | --- |
| Receive private messages | ✅ |  |
| Receive group mention messages | ❌ | Customer Service does not support group chat |
| Receive group regular messages | ❌ |  |
| Receive image messages | ✅ |  |
| Receive voice messages | ❌ |  |
| Receive file messages | ❌ |  |
...
| Receive private messages | ✅ |  |
| Receive group mention messages | ✅ |  |
| Receive group regular messages | ❌ | WeCom Intelligent Bot only supports receiving mention messages |
| Receive image messages | ✅ |  |
| Receive voice messages | ✅ |  |
| Receive file messages | ✅ |  |
| Receive rich text messages | ✅ | Text and image combined |
...
| --- | --- | --- |
| Receive private messages | ✅ |  |
| Receive group mention messages | ❌ | Official Account does not support group chat |
| Receive group regular messages | ❌ |  |
| Receive image messages | ❌ |  |
| Receive voice messages | ❌ |  |
| Receive file messages | ❌ |  |
| Receive rich text messages | ❌ |  |
| Get private message event user name | ❌ | Official Account does not support getting user name |
| Get group message event group name | ❌ |  |
| Get group message event sender name | ❌ |  |
...
| Receive private messages | ✅ |  |
| Receive group mention messages | ✅ |  |
| Receive group regular messages | ❌ | Slack only supports receiving messages that mention the bot |
| Receive image messages | ✅ |  |
| Receive voice messages | ❌ |  |
| Receive file messages | ❌ |  |
| Receive rich text messages | ❌ |  |
...
| Reply to private messages | ✅ |  |
| Reply to group messages | ✅ |  |
| Reply with image messages | ✅ | Via URL unfurling |
| Reply with voice messages | ❌ |  |
| Reply with file messages | ❌ |  |
| Reply with rich text messages | ❌ |  |
| Send proactive messages | ✅ |  |
...
| Receive file messages | ❌ |  |
| Receive rich text messages | ❌ |  |
| Get private message event user name | ❌ | LINE does not support getting user name |
| Get group message event group name | ❌ | LINE does not support getting group name |
| Get group message event sender name | ❌ | LINE does not support getting sender name |
