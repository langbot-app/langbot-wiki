...
LangBot is an **open-source, production-grade**, LLM-native instant messaging bot platform. It connects large language models — OpenAI, Anthropic, Gemini, DeepSeek and more — and Agent platforms like Dify, Coze and n8n to mainstream global messaging platforms including QQ, WeChat, WeCom, Lark, DingTalk, Discord, Telegram and Slack. With built-in Agent, RAG knowledge base, MCP, Skills and a code sandbox, plus an out-of-the-box web management panel, you can get your AI bot online in minutes — no hand-written config files required.

## What You Can Build

- **AI customer service / enterprise assistant**: deploy a knowledge-base-backed AI agent to WeChat, WeCom, Lark or DingTalk to answer customer and employee questions automatically.
- **Community operations**: provide AI-powered Q&A, content moderation and interaction in QQ, Discord and Telegram groups.
